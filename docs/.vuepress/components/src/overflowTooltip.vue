...
import EditorMixin from '../../../../plugins/components/editor/EditorMixin'
import * as utils from '../../../../plugins/components/editor/utils'
export default {
  name: 'Editor',
  mixins: [EditorMixin],
  components: {
    ShowWordLimit: () => import('../../../../plugins/components/editor/ShowWordLimit')
  },
  data () {
    return {
      content: '',
